...
C_FLAGS += -DTARGET_M4
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1545387299.05
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1545387299.05
...
ASM_FLAGS += -include
ASM_FLAGS += /filer/workspace_data/exports/f/f8ce009dbdd5c78ea3fc57796429bf9f/Nucleo_blink_led/mbed_config.h
ASM_FLAGS += -x
ASM_FLAGS += assembler-with-cpp
ASM_FLAGS += -c
ASM_FLAGS += -Wall
